...
ALTER TABLE IF EXISTS "tournament" ADD COLUMN "winner_id" INTEGER REFERENCES "match"("id");
ALTER TABLE IF EXISTS "match" ADD COLUMN "state_id" INTEGER REFERENCES "state"("id");{"text":"title","cur":{"from":5,"to":5}}
