...
ALTER TABLE "team_has_user"
    ...
    ADD CONSTRAINT team_has_user_user_id_fkey FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE,
    ADD CONSTRAINT team_has_user_team_id_fkey FOREIGN KEY ("team_id") REFERENCES "team"("id") ON DELETE CASCADE;
