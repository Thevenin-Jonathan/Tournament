...
-- ALTER DATABASE "tournament" SET DATESTYLE TO "ISO, DMY"; -- Uncomment for development DB / Comment for production
ALTER DATABASE "d4e528emrou64t" SET DATESTYLE TO "ISO, DMY"; -- Uncomment for production DB / Comment for development
